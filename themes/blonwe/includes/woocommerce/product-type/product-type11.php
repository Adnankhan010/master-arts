...
/*----------------------------------
  Product Type 11
 -----------------------------------*/
if(!function_exists('blonwe_product_type11')){  
	function blonwe_product_type11($stockprogressbar = '', $stockstatus = '', $shippingclass = '', $countdown = '', $product_sku = '', $productattributes = '', $product_brands = ''){
		global $product;
		global $post;
		global $woocommerce;
		...
		$postview  = isset( $_POST['shop_view'] ) ? $_POST['shop_view'] : '';
			...
			$output .= '<div class="product-wrapper style-6 background-white product-type-11">';
