...
/*----------------------------------
  Product Type 9
 -----------------------------------*/
if(!function_exists('blonwe_product_type9')){ 
	function blonwe_product_type9($stockprogressbar = '', $stockstatus = '', $shippingclass = '', $countdown = '', $product_sku = '', $productattributes = '', $product_brands = ''){
		global $product;
		global $post;
		global $woocommerce;
		...
		$postview  = isset( $_POST['shop_view'] ) ? $_POST['shop_view'] : '';
			$output .= '<div class="product-wrapper style-3 product-type-9">';
