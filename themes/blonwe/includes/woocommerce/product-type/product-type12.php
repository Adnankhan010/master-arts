...
/*----------------------------------
  Product Type 12
 -----------------------------------*/
if(!function_exists('blonwe_product_type12')){ 
	function blonwe_product_type12($stockprogressbar = '', $stockstatus = '', $shippingclass = '', $countdown = '', $product_sku = '', $productattributes = '', $product_brands = ''){
		global $product;
		global $post;
		global $woocommerce;
		...
		$postview  = isset( $_POST['shop_view'] ) ? $_POST['shop_view'] : '';
			...
			$output .= '<div class="product-wrapper style-8 product-type-12">';
