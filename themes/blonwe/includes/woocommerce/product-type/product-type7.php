...
/*----------------------------------
  Product Type 7
 -----------------------------------*/
if(!function_exists('blonwe_product_type7')){ 
	function blonwe_product_type7($stockprogressbar = '', $stockstatus = '', $shippingclass = '', $countdown = '', $product_sku = '', $productattributes = '', $product_brands = ''){
		global $product;
		global $post;
		global $woocommerce;
		...
		$postview  = isset( $_POST['shop_view'] ) ? $_POST['shop_view'] : '';
			...
			$output .= '<div class="product-wrapper style-5 centered image-gray product-type-7">';
